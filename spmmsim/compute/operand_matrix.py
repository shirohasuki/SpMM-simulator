...
class operand_matrix(object):
    ...
    def set_params(self,
        ...
        self.ifmap_rows, self.ifmap_cols = self.workload.get_layer_ifmap_dims(self.layer_id)
        self.filter_rows, self.filter_cols = self.workload.get_layer_filter_dims(self.layer_id)
        self.num_input_channels = self.workload.get_layer_num_channels(self.layer_id)
        self.num_filters = self.workload.get_layer_num_filters(self.layer_id)
        self.row_stride, self.col_stride = self.workload.get_layer_strides(self.layer_id)
        # TODO: Marked for cleanup
        ...
        self.ofmap_rows, self.ofmap_cols = self.workload.get_layer_ofmap_dims(self.layer_id)
        ...
        self.conv_window_size = int(self.workload.get_layer_window_size(self.layer_id))
